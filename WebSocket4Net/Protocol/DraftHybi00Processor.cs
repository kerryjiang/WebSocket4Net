...
namespace WebSocket4Net.Protocol
{
	...
	class DraftHybi00Processor : ProtocolProcessorBase
	{
		...
		{
			var key1 = GenerateSecKey();
			string secKey1 = Encoding.UTF8.GetString(key1, 0, key1.Length);
			var key2 = GenerateSecKey();
			string secKey2 = Encoding.UTF8.GetString(key2, 0, key2.Length);
